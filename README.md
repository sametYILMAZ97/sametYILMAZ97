...
## 🌐 Connect with me: [![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/samet-yilmaz-fd-nd/)

## 🏢 Professional Experience

### 🔹 **Dost Agriculture Technologies** | Frontend Developer _(Jun 2025 - Present)_

- 🌱 Developing **farm management** web and mobile applications
- 🐄 Building **automated systems** user interfaces
- 🤖 Creating **robot control** dashboards and real-time animal tracking maps
...
### 🔹 **VSCode Theme Generator** | CLI Tool
...
> Generate custom VSCode themes from colors using advanced algorithms (Fibonacci ratios)

- 🎨 Generate themes from single color or color palette with harmonious color algorithms
- 🌓 Support for **dark**, **light**, or **both** theme variants
- 💻 Syntax highlighting for **9 languages** (JS, TS, Go, Python, Rust, C, Java, PHP, Ruby)
- 📦 Output as JSON theme files or **auto-install** as VSCode extension
...
> A powerful, Vivaldi-inspired screenshot extension for Chrome & Chromium browsers

- 🎯 **Capture Element** - Auto-detect & highlight elements with keyboard navigation
- ✂️ **Capture Area** - Drag-and-drop custom rectangular selection
- 📜 **Capture Full Page** - Auto-scroll and stitch into single high-quality image
- 🔧 **Smart Features** - Handles sticky elements, overflow content, scroll-and-stitch technology
...
> Electron-based desktop app for managing Windows 11 context menu entries

- 🖥️ **Visual Interface** with live registry view
- 🔒 **Safe Operations** using standard `LegacyDisable` flag - fully reversible
- 🔍 Flexible filtering by target (files, folders, background, drive)
- 💾 **Backup & Restore** context menu configurations
- ⚡ Both **GUI application** and **PowerShell CLI** available

---

### 🔹 **Everforest Theme for VS Code** | Theme

> A comfortable and pleasant VS Code theme based on the Everforest color palette

- 🌓 **Two variants**: Dark and Light themes
- 🎨 Carefully crafted colors based on official Everforest scheme
...
[![Repo](https://img.shields.io/badge/GitHub-Repository-181717?logo=github)](https://github.com/sametYILMAZ97/linkedin-job-searcher-nuxt) [![Live Demo](https://img.shields.io/badge/Live-Demo-00DC82?logo=vercel)](https://linkedin-job-searcher-nuxt.vercel.app/)

> Modern Nuxt 3 web application for generating optimized LinkedIn job search URLs
...
- 🛠️ **6+ Open Source Projects** including developer tools and browser extensions
