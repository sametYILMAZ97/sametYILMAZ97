...
🏆 **TEKNOFEST Winner** — First Place, Autonomous Robots in Industry
...
- 📐 Supports **JSON**, **JSONC** (comments & trailing commas preserved), and **JSON5**
- 🔑 Schema-aware key priority, format / minify, and region-only sorting
- ⌨️ Exposed as editor **code actions** (`Cmd+.` / right-click)
